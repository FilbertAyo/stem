...
<main>
    ...
    <section class="i pg fh rm ki xn vq gj qp gr hj rp hr">
      ...
      <div class="animate_top bb af i va sg hh sm vk xm yi _n jp hi ao kp">
        ...
        <div class="rj">
          <h2 class="ek ck kk wm xb">Sign in to Adilisha STEM Lab</h2>
          <p>Log in to guide your learners, track progress and unlock new immersive modules.</p>

          <h3 class="hk yj kk wm ob mc">Sign in with your organization credentials</h3>
        ...
        <form class="sb" method="POST" action="{{ route('login') }}">
          ...
          <div class="tc uf wf ag jq mb-6">
            <label class="tc wf ag">
              <input
                id="remember_me"
                type="checkbox"
                name="remember"
          ...
          <button type="submit" class="vd rj ek rc rg gh lk ml il _l gi hi mt-3">
            Sign In
          </button>
