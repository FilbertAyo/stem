...
<main>
    ...
    {{-- <section class="i pg ji gp uq">
      ...
      <!-- Section Title Start -->
      <div
        x-data="{ sectionTitle: `Meet the women leading Adilisha STEM Lab`, sectionTitleText: `Our facilitators, technologists and community organizers collaborate to make science and technology accessible to every Tanzanian girl.`}">
      ...
      <div class="bb ze i va ki xn xq jb jo">
        <div class="wc qf pn xo gg cp">
          ...
          <div class="animate_top rj">
            ...
            <h4 class="yj go kk wm ob zb">Zainabu Mussa</h4>
            <p>VR Curriculum Lead</p>
          </div>
          ...
          <div class="animate_top rj">
            ...
            <h4 class="yj go kk wm ob zb">Neema Gabriel</h4>
            <p>STEM Mentorship Coordinator</p>
          </div>
          ...
          <div class="animate_top rj">
            ...
            <h4 class="yj go kk wm ob zb">Asha Kessy</h4>
            <p>Technology Inclusion Advocate</p>
          </div>
        </div>
      </div>
    </section> --}}
    ...
    <section id="subjects" class="lj tp kr">
      ...
      <div class="bb ze ki xn yq mb en">
        <div class="wc qf pn xo ng">
          ...
          <div class="animate_top sg oi pi zq ml il am cn _m">
            <img src="{{ asset('images/icon-05.svg') }}" alt="Icon" />
            <h4 class="ek zj kk wm nb _b">Coding & Robotics</h4>
            <p>Create programs, automate tasks and prototype robots with collaborative challenges.</p>
          </div>

          <!-- Service Item -->
          <div class="animate_top sg oi pi zq ml il am cn _m">
            <img src="{{ asset('images/icon-06.svg') }}" alt="Icon" />
            <h4 class="ek zj kk wm nb _b">Mentorship & Careers</h4>
            <p>Connect with women in STEM, access role models and map your future learning pathway.</p>
          </div>
        </div>
      </div>
    </section>
                ...
                <div class="i hh rm sg vk xm bi qj">
                  ...
                  <div class="tc sf rn tn un zf dp">
                    ...
                    <div>
                      <img src="{{ asset('images/icon-quote.svg') }}" alt="Quote" />
                      <p class="ek ik xj _p kc fb">
                        "Building my first solar-powered car here showed me that girls from Arusha can design real solutions for our communities."
                      </p>
                      <div class="tc yf vf">
                        <div>
                          <span class="rc ek xj kk wm zb">Aisha Mwakyusa</span>
                          <span class="rc">Form 3 student, Arusha</span>
                        </div>
                ...
                <div class="i hh rm sg vk xm bi qj">
                  ...
                  <div class="tc sf rn tn un zf dp">
                    ...
                    <div>
                      <img src="{{ asset('images/icon-quote.svg') }}" alt="Quote" />
                      <p class="ek ik xj _p kc fb">
                        "Mentoring through the lab proves our girls are ready for aerospace and robotics careers when we invest in their talent early."
                      </p>

                      <div class="tc yf vf">
                        <div>
                          <span class="rc ek xj kk wm zb">Dr. Zawadi Kweka</span>
                          <span class="rc">Aerospace mentor, Adilisha Network</span>
                        </div>
    ...
    <section class="pj vp mr">
      <!-- Section Title Start -->
      <div
        x-data="{ sectionTitle: `Partners championing girls in STEM`, sectionTitleText: `We collaborate with schools, community organizations and innovation hubs to make immersive science education a reality.`}">
        <div class="animate_top bb ze rj ki xn vq">
          <h2 x-text="sectionTitle" class="fk vj pr kk wm on/5 gq/2 bb _b">
          </h2>
          <p class="bb on/5 wo/5 hq" x-text="sectionTitleText"></p>
